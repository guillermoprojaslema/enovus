...
return [
    ...
    'dimmer' => [
        ...
        'noticia_link_text'  => 'Ver todas las noticias',
        'noticia_text'       => 'Tiene :count :string en su base de datos. Haga clic en el botón de abajo para ver todas las noticias. ',
        'pagina'             => 'Página|Páginas',
        'pagina_link_text'   => 'Ver todas las páginas',
        'pagina_text'        => 'Tiene :count :string en su base de datos. Haga clic en el botón de abajo para ver todas las páginas. ',
        'producto'           => 'Producto|Productos',
        'producto_link_text' => 'Ver todos los productos',
        'producto_text'      => 'Tiene :count :string en su base de datos. Haga clic en el botón de abajo para ver todos los productos. ',
        ...
        'garantia_link_text'     => 'Ver todas las garantías',
        'garantia_text'          => 'Tiene :count :string en su base de datos. Haga clic en el botón de abajo para ver todas las garantías. ',
        'categoria'               => 'Categoría|Categorías',
        'categoria_link_text'     => 'Ver todas los categorías',
        'categoria_text'          => 'Tiene :count :string en su base de datos. Haga clic en el botón de abajo para ver todas los categorías.',
